...
fs.readFile('locales/ru.json', (e, data) => {
    ...
    fs.writeFile('ru_components_extracted.json', JSON.stringify(lang, null, ' '), () => { console.log('Locale extracted') })
})
...
fs.readFile('locales/ru.json', (e, data) => {
    ...
    fs.writeFile('ru_pages_extracted.json', JSON.stringify(lang, null, ' '), () => { console.log('Locale extracted') })
})
