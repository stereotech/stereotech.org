      ...
      <v-row>
        ...
        <v-col cols="12" md="6">
          ...
          <v-form>
              ...
              <v-text-field v-model="phoneNumber" v-mask="mask" label="Телефон" outlined></v-text-field>
...
export default class BuyPrinter extends Vue {
  ...
  private series3xxModels: Model[] = [{
      modelName : '320 student edition V4',
  ...
  {
    modelName: '320 teacher edition V4',
